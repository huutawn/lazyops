...
type ProjectRepoLink struct {
	...
	GitHubInstallationID string    `json:"github_installation_id" gorm:"size:64;not null;index:idx_project_repo_links_installation_repo;uniqueIndex:idx_project_repo_links_route,priority:1"`
	GitHubRepoID         int64     `json:"github_repo_id" gorm:"not null;index:idx_project_repo_links_installation_repo;uniqueIndex:idx_project_repo_links_route,priority:2"`
