...
func TestBuildCallbackServiceSuccessCreatesArtifactReadyRevision(t *testing.T) {
	...
	service := NewBuildCallbackService(projectStore, blueprintStore, revisionStore, buildStore, nil)
...
func TestBuildCallbackServiceRejectsArtifactMismatch(t *testing.T) {
	...
	service := NewBuildCallbackService(newFakeProjectStore(), newFakeBlueprintStore(), newFakeDesiredStateRevisionStore(), buildStore, nil)
...
func TestBuildCallbackServiceRejectsUnknownBuildJob(t *testing.T) {
	service := NewBuildCallbackService(newFakeProjectStore(), newFakeBlueprintStore(), newFakeDesiredStateRevisionStore(), newFakeBuildJobStore(), nil)
...
func TestBuildCallbackServiceBroadcastsFailureEvent(t *testing.T) {
	...
	service := NewBuildCallbackService(projectStore, newFakeBlueprintStore(), newFakeDesiredStateRevisionStore(), buildStore, broadcaster)
