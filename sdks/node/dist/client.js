...
class LazyOpsClient {
     ...
     */
    async fetch(serviceName, path, options) {
        const service = await this.resolve(serviceName);
        const url = new url_1.URL(path, service.url);
     ...
     */
    getInternalServiceConnectionString(kind) {
...
exports.LazyOpsClient = LazyOpsClient;
