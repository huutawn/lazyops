        ...
        <div className="grid gap-4 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="rounded-xl border border-[#1e293b] bg-[#0B1120]/30 p-6">
            <div className="flex items-center justify-between">
              <h3 className="text-base font-semibold text-white">Danh sách keys</h3>
              <span className="text-sm text-lazyops-muted">{keys.length} keys</span>
            </div>
            ...
            return (
              <div key={copyKey} className="rounded-xl border border-[#1e293b] bg-[#0B1120]/30 p-6">
                <div className="flex items-center justify-between gap-3">
                  <div>
                    <h3 className="text-base font-semibold text-white">{snippet.alias}</h3>
                    <p className="text-sm uppercase tracking-wider text-lazyops-muted">{snippet.service_kind}</p>
                  </div>
                  <button
                    type="button"
                ...
                <pre className="mt-3 overflow-x-auto rounded-xl bg-[#020617] px-6 py-3 text-sm text-[#cbd5e1]">
