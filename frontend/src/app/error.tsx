      ...
      <body>
        <div className="flex min-h-screen items-center justify-center p-8">
          <div className="w-full max-w-md rounded-xl border border-health-unhealthy/30 bg-lazyops-card p-8 text-center">
            ...
            <p className="mb-4 text-base text-lazyops-muted">
            ...
            <div className="flex justify-center gap-3">
              ...
              <button
                type="button"
                className="rounded-lg border border-lazyops-border px-6 py-2 text-base font-medium text-lazyops-muted transition-colors hover:text-lazyops-text"
            ...
            {process.env.NODE_ENV === 'development' && error.message && (
              <pre className="mt-4 overflow-x-auto rounded-lg bg-lazyops-bg-accent p-3 text-left text-sm text-lazyops-muted">
                {error.message}
              </pre>
            )}
          </div>
