...
Implementation status now lives in `docs/contracts-matrix.md`. This section remains the target contract inventory and naming source.
...
- `POST /api/v1/builds/callback`

#### Projects, targets, and runtime
...
- `POST /api/v1/projects/:id/init/validate-lazyops-yaml`
...
- `POST /api/v1/tunnels/tcp/sessions`
- `DELETE /api/v1/tunnels/sessions/:id`
